...
@Test
public void testDoubleValidWriteLibMapTensorTensor() {
	WriteLibMapTensorTensorHelper helper = new WriteLibMapTensorTensorHelper();
	
	try{
    		
	    //create a temp file
	    File temp = File.createTempFile("tempfileWriteLibMapTensorTensorHelper", ".tmp"); 
...
@Test
public void testAnotherFalseWriteLibMapTensorTensor() {
	for(int i=1;i<100;i++) {
		assertFalse(false);
	}
}
